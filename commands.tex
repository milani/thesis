...
\usepackage[top=30mm, bottom=30mm, left=25mm, right=35mm, headheight=15pt]{geometry}
...
\tikzset{node distance=0.28cm,minimum size=0.17cm,inner sep=0,font=\tiny,
node/.style={circle,draw,fill,align=center},
node2/.style={circle,draw,fill,double=black,color=gray,align=center},
node3/.style={circle,draw,thick,align=center},
node4/.style={circle,draw,fill,double=black,color=gray!30,align=center}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\جستار}[1] {\cite{#1}}
\newcommand{\ارجا}[1]{\ref{#1}}
\newcommand{\درشت}[1]{\textbf{#1}}
\newcommand{\خمیده}[1]{\textit{#1}}
\newcommand{\فقره}{\item}
\newcommand{\متنلاتین}[1]{\lr{#1}}
\newcommand{\پانوشت}[1]{\footnote{#1}}
%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\گراف}[1]{$#1 = (V,E)$}
\newcommand{\graph}[3]{\ensuremath{#1 = (#2,#3)}}
\newcommand{\یال}[2]{$(v_{#1},v_{#2})$}
\newcommand{\edge}[4]{\ensuremath{(#1_{#2},#1_{#3}) \in #4}}
\newcommand{\Ui}{$u_{i}$}
\newcommand{\Uj}{$u_{j}$}
\newcommand{\Vi}{$v_{i}$}
\newcommand{\Vj}{$v_{j}$}
...
\GlsSetXdyLanguage[persian]{persian-variant1}
\GlsSetXdyLanguage[english]{english}
\glsdisablehyper
\makeglossaries
...
\newcommand{\renewglossaryentry}[1]{\ifglsentryexists{#1}{\global\csundef{glo@#1@name}}{}\newglossaryentry{#1}}

\newcommand{\newword}[4]{\renewglossaryentry{#1}     {type={english},name={\lr{#2}},plural={#4},text={#3},description={}}
\renewglossaryentry{f-#1} {type={persian},name={#3},text={\lr{#2}},description={}}}
